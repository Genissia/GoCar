...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_EMAIL + " TEXT UNIQUE," + KEY_UID + " TEXT," + KEY_AGE + "TEXT" + KEY_NATIONALITY + "TEXT" + KEY_PHONENUMBER + "TEXT"
                + KEY_CREATED_AT + " TEXT" + ")";//here
     ...
     * */
    public void addUser(String name, String email, String uid,String Age, String Nationality, String PhoneNumber,String created_at) {//here
